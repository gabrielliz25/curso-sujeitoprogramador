...
class Loja {
    ...
    adicionarProd(nome, preco, quantidade) {
        let prod = {
    ...
    removerProd(id, quantidade) {
        ...
        console.log(`Removido ${quantidade || 1} produto(s) de '${prodCurrent.nome}'`);
        this.totalProds = this.calcularTotalProdutos();
    }
    consultarProdutos() {
...
//# sourceMappingURL=SistemaEstoque.js.map